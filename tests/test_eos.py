...
def test_eos_gamma_law_react():
    eos_inert = Gamma_law(5.0/3.0)
    eos = Gamma_law_react(5.0/3.0, 0.5, 1.0, 10.0, eos_inert)
    rho = 1.0
    eps = 1.0
    p_true = 1.0 / 3.0
    h_true = 7.0 / 3.0
...
def test_eos_polytrope_law():
    eos = Polytrope_law([5.0/3.0, 5.0/3.0], 7.0/5.0, 1.5, [1.0, 1.0])
    rho = 1.0
    eps = 2.0
    p_true = 1.2
    h_true = 5.7
...
def test_eos_polytrope_law_cold():
    ...
    """
    eos = Polytrope_law([5.0/3.0, 7.0/5.0], 7.0/5.0, 0.5, [1.0, 1.0])
    rho = 1.0
    eps = 2.0
    p_true = 1.0
    h_true = 6.372102242
