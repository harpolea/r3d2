...
class Gamma_law_react(EOS):
    ...
    def h_from_rho_eps(self, rho, eps):
        return self.gamma * eps + (1.0 - self.gamma) * self.q
    ...
    def h_from_rho_p(self, rho, p):
        return self.gamma / (self.gamma - 1.0) * p / rho + self.q
