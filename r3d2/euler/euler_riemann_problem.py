...
from r3d2.euler.euler_wave import EulerWave, EulerWaveSection
from r3d2.euler import utils


class EulerRiemannProblem(RiemannProblem):
    """
    ...
    def plot_P_v(self, ax, fig, var_to_plot="velocity"):
        ...
        if len(self.waves[0].wave_sections) == 3:
            ...
            ax.text(i_v, i_p, r"$i_S$", transform=trans_offset, horizontalalignment='center',
                 verticalalignment='bottom')
            j2, rho, eps, diffp = EulerWaveSection.mass_flux_squared(
